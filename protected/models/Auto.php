...
class Auto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('mensaje, descripcion, created_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, marca, modelo, kilometraje, color, precio, anio, mensaje, descripcion, destacado, created_at, estado', 'safe', 'on'=>'search'),
		);
	}
