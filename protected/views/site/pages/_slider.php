    ...
    <div class="rev_slider" data-version="5.0">
        <ul>
            <?php foreach ($sliders as $k => $slider): ?>
                <li data-index="rs-<?= $k ?>" data-transition="slidingoverlayhorizontal" data-slotamount="default" 
                    data-easein="default" data-easeout="default" data-masterspeed="default"
                    data-thumb="<?= $slider['image'] ?>" 
                    data-rotate="0" data-saveperformance="off" data-title="Slide <?= $k ?>" data-description="">
                    <!-- MAIN IMAGE -->
                    ...
                    <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway 
                         bg-theme-colored-transparent border-right-theme-color-2-6px pr-20 pl-20"
                         id="rs-<?= $k ?>-layer-1"
                    ...
                    <?php if ($slider['button']): ?>
                        <div class="tp-caption tp-resizeme" 
                            ...
                            <a class="btn btn-colored btn-lg btn-flat btn-theme-colored btn-theme-colored border-right-theme-color-2-6px pl-20 pr-20" 
                               href="<?= $slider['link'] ?>"><?= $slider['button'] ?></a> 
                        </div>
                    <?php endif; ?>
                </li>
            <?php endforeach; ?>
