...
class ServiciosController extends Controller {
    ...
    public function actionCreate() {
        $model = new Servicios;
        $post  = Yii::app()->request->getPost('Servicios', false);
        ...
        if ($post) {
            ...
            if ($model->save()) {
                ...
                if (trim($file) != "") {
                    ...
                    $urlFile = Yii::getPathofAlias('webroot.files.media.servicios');
    ...
    public function actionIndex() {
        ...
        $attributes = Yii::app()->request->getQuery('Servicios', false);
        if ($attributes) {
