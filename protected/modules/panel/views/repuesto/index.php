...
<h1>
    Administrador de Repuestos    <a class="pull-right btn btn-success" href="<?= $this->createUrl("create") ?>">Nuevo</a>
</h1>
    ...
    $this->widget('zii.widgets.grid.CGridView', [
        ...
        'columns'      => [
            ...
            [
                ...
                'value'       => function ($data) {
                    if ($data->image) {
                        echo '<img width="80px" src="' . Yii::app()->getBaseUrl(true) . '/files/media/repuestos/' . $data->image . '" />';
                    }
                }
            ],
            [
